 ...
 * @author carri
 */
public class InterfacePoduct extends javax.swing.JFrame {

	Conexion conexion; 
	/**
	 * Creates new form InterfacePoduct
	 */
	public InterfacePoduct() {
		initComponents();
	...
	public void llenarTabla(){
		try{
			...
			String [][] products = this.conexion.getProducts();
			for (int i = 0; i < products.length; i++){ 
				model.addRow(products[i]);
			}
		}catch(Exception e){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
		InterfaceSelectImg intSelectImg = new InterfaceSelectImg(); 
		intSelectImg.setVisible(true);
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(InterfacePoduct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new InterfacePoduct().setVisible(true);
			}
		});
	}
