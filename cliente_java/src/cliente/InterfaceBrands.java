...
public class InterfaceBrands extends javax.swing.JFrame {
    ...
    public void cargarMarcas() throws Exception{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceBrands.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfaceBrands().setVisible(true);
            }
        });
    }
